...
android {
    ...
    defaultConfig {
        ...
        minSdk = 26
        targetSdk = 34
        versionCode = providers.gradleProperty("guardpulse.versionCode").orElse("8").get().toInt()
        versionName = providers.gradleProperty("guardpulse.versionName").orElse("0.2.6").get()
    }
